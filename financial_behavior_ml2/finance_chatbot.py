...
class FinanceChatbot:
    ...
    def run_analysis(self, user_data=None):
        """Run the financial analysis or use random sample if None provided"""
...
"""
        ...
        try:
            ...
            self.chat = self.model.start_chat(history=[
                {"role": "user", "parts": ["Initialize financial advisor with my financial analysis"]},
                {"role": "model", "parts": [f"I've analyzed your financial data and I'm ready to provide personalized advice. How can I help you today?"]}
            ])
            
            print("\nFinancial Advisor Chatbot (powered by Gemini)")
            print("----------------------------------------------")
            print("I've analyzed your financial data and I'm ready to provide personalized advice.")
            ...
            while True:
                ...
                try:
                    # Send user message with context and get response
                    ...
                    print("Let me try to restart our conversation.\n")
                    try:
                        # Try to restart the chat session
                        self.chat = self.model.start_chat(history=[
                            {"role": "user", "parts": [system_prompt]},
                            {"role": "model", "parts": ["I've analyzed your financial data and I'm ready to help again. How can I assist you?"]}
                        ])
                    except Exception as restart_err:
                        print(f"Error restarting chat: {str(restart_err)}")
...
if __name__ == "__main__":
    # Gemini API key
    API_KEY = "AIzaSyAZ0dC8hFfv1tlDyBtwnNJfCTlawgq9CkY"
